...
if RUN_TO_LOAD != None:
 ...
 \
    ...
    MODEL_SAVE_RATE = int(os.getenv('MODEL_SAVE_RATE', 500))
...
print("name:",RUN_NAME, "out_dir: ",OUTPUT_DIRECTORY, "run_dir: ", RUN_DIRECTORY, "config_dir: ", CONFIG_DIRECTORY)
                           #conf_file=TELEGRAM_CONFIG_FILE
